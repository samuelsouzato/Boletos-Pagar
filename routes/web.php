...
//Visualizar
Route::get('/contas.show/{conta}', [ContaController::class, 'show'])->name('contas.show');

//Carregar o Formulário editar
Route::get('/contas.edit{conta}', [ContaController::class, 'edit'])->name('contas.edit');

//Receber os dados do formulário e editar (put)
Route::put('/contas.update/{conta}', [ContaController::class, 'update'])->name('contas.update');

//Apagar (delete)
Route::delete('/contas.destroy/{conta}', [ContaController::class, 'destroy'])->name('contas.destroy');
